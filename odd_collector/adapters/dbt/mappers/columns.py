...
from . import _data_set_field_metadata_schema_url, _data_set_field_metadata_excluded_keys
from .metadata import _append_metadata_extension
from .types import TYPES_SNOWFLAKE_TO_ODD


def map_column(column: dict, oddrn_generator: DbtGenerator, owner: str, parent_oddrn_path: str) -> DataSetField:
    ...
    _append_metadata_extension(dsf.metadata, _data_set_field_metadata_schema_url, column, _data_set_field_metadata_excluded_keys)
