...
class Adapter(AbstractAdapter):
    ...
    def get_data_entity_list(self) -> DataEntityList:
        ...
        connector = DatasetGenerator.get_generator(connector_details.service, **connector_details.config)
        destination = DatasetGenerator.get_generator(destination_details.service, **destination_details.config)
        entities = [
            map_transformers(
                self._generator,
