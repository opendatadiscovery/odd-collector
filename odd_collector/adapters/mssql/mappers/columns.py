...
def map_column(
        column_metadata: ColumnMetadataNamedtuple, oddrn_generator: MssqlGenerator, owner: str, parent_oddrn_path: str
) -> DataSetField:
    return DataSetField(
        ...
        type=DataSetFieldType(
            type=TYPES_SQL_TO_ODD.get(__convert_bytes_to_str(column_metadata.data_type), Type.TYPE_UNKNOWN),
