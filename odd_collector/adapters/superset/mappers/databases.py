...
def create_databases_entities(oddrn_generator: SupersetGenerator, datasets: List[Dataset]) -> List[DataEntity]:
    databases_ids_names: Dict[int, str] = {dataset.database_id: dataset.database_name for dataset in datasets}
        ...
        databases_entities.append(
            DataEntity(
                ...
                data_entity_group=DataEntityGroup(
                    entities_list=[dataset.get_oddrn(oddrn_generator) for dataset in datasets
