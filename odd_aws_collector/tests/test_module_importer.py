...
import sys
import pytest
from odd_aws_collector.domain.plugin import DynamoDbPlugin, GluePlugin

from odd_aws_collector.domain.collector_config import CollectorConfig
from odd_aws_collector.domain.collector_config_loader import CollectorConfigLoader
from odd_aws_collector.domain.adapters_initializer import AdaptersInitializer
from odd_aws_collector.domain.adapters_folder_meta import AdapterFolderMetadata
