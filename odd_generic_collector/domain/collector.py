...
from odd_generic_collector.domain.register_datasource_request import (
    RegisterDataSourceRequest,
    RegisterDataSourceRequests,
)
from odd_generic_collector.services.datasource_api import DataSourceApi

from odd_generic_collector.services.http_client import HttpClient
...
class Collector:
    def __init__(
        ...
        adapter_initializator = AdaptersInitializer(
            adapters_folder_meta, self.config.plugins
        )
        self.adapters_with_plugins = adapter_initializator.init_adapters()
